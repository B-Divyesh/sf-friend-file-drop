...
| The relay receives file names, hashes, contents, IP addresses, and byte counts. | 12 |
| It holds up to 25 MB until the receipt or room expiry. | 12 |
| Use the private relay | 4 |
| Join the sender's room | 4 |
...
| Room connection details expire after 15 minutes. | 7 |
| The app never asks for your contacts. | 7 |
| Files go direct unless both people choose the relay. | 9 |
